...
contract('BeniToken', function(accounts) {
    var tokenInstance;
    ...
    it('initializes the contract with the correct values', function() {
        return BeniToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Beni Token', 'has the correct name');
            return tokenInstance.symbol();
        }).then(function(symbol) {
            assert.equal(symbol, 'BENI', 'has the correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'Beni Token v1.0', 'has the correct standard');
        });
    })
    ...
    it('handles delegated token transfers', function() {
        return BeniToken.deployed().then(function(instance) {
            ...
            assert.equal(balance.toNumber(), 10, 'adds the amount to the receving account')
